...
describe 'AssocOptions' do
  describe 'BelongsToOptions' do
    ...
    it 'allows overrides' do
      options = BelongsToOptions.new('guardian',
  ...
  describe 'HasManyOptions' do
    ...
    it 'allows overrides' do
      ...
      expect(options.foreign_key).to eq(:guardian_id)
...
describe 'Associatable' do
  ...
  before(:all) do
    class Cat < SQLObject
      belongs_to :human, foreign_key: :guardian_id
    ...
    class Human < SQLObject
      ...
      has_many :cats, foreign_key: :guardian_id
      belongs_to :house
